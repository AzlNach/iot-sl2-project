...
const translations = {
  en: {
    ...
    'landing.features.aiAnalyticsDesc': 'Smart analysis with Meta Llama 3.3 70B via OpenRouter for irrigation recommendations',
    ...
    'landing.features.ai.desc': 'Get intelligent recommendations powered by Meta Llama 3.3 70B via OpenRouter',
  ...
  id: {
    ...
    'landing.features.aiAnalyticsDesc': 'Analisis cerdas dengan Meta Llama 3.3 70B via OpenRouter untuk rekomendasi irigasi',
    ...
    'landing.features.ai.desc': 'Dapatkan rekomendasi cerdas berbasis Meta Llama 3.3 70B via OpenRouter',
